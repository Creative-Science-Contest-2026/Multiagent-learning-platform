...
| --- | --- | --- | --- | --- | --- |
| Knowledge Pack | Metadata form filled with demo-safe subject, grade, curriculum, objectives, owner, and sharing status | Browser capture | Current | Teacher sets the trusted learning context before assessment or tutoring begins. | Refreshed on 2026-04-30 in `docs/browser-recapture-refresh-20260430`; see `01-knowledge-pack-metadata.png`. |
| Knowledge Pack | Metadata still visible after reload | Browser capture | Current | The configured classroom context persists after reload rather than living only in one transient form. | Refreshed on 2026-04-30 in `docs/browser-recapture-refresh-20260430`; see `02-knowledge-pack-after-reload.png`. |
...
| Tutor Agent | Student asks a follow-up question | Browser capture | Current | The student can continue from assessment into adaptive tutoring on the same topic. | Refreshed on 2026-04-30 in `docs/browser-recapture-refresh-20260430`; current merged UI shows the seeded tutor transcript through the teacher-facing replay route `dashboard/sessions/contest-tutor-demo`. |
| Tutor Agent | Tutor response with learning context | Browser capture | Current | The tutor gives support inside the same classroom loop rather than acting as a final judge. | Refreshed on 2026-04-30 in `docs/browser-recapture-refresh-20260430`; see `06-tutor-agent-answer.png` from the replay surface. |
| Dashboard | Evidence-first teacher insight overview visible | Browser capture | Current | The teacher sees reviewed signals and recommended next moves in one operating surface. | Refreshed on 2026-04-30 in `docs/browser-recapture-refresh-20260430`; see `05-dashboard-evidence-first-overview.png`. |
| Dashboard | Recent activity still visible below the teacher insight workflow | Browser capture | Current | The teacher can trace the supporting activity behind the dashboard recommendation layer. | Refreshed on 2026-04-30 in `docs/browser-recapture-refresh-20260430`; see `09-dashboard-recent-activity-evidence-first.png`. |
...
| Screenshots are captured and linked | Passed | Knowledge, Tutor, Dashboard, and `/agents` rows were recaptured on 2026-04-30 and now match the current merged contest-facing UI. |
