...
- Screenshot evidence is captured in [`screenshots/`](./screenshots/), and the stale Knowledge, Tutor, Dashboard, and `/agents` rows were recaptured on 2026-04-30 against the current merged contest-facing UI.
