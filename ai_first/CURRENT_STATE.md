...
- Current branch for this lane: `docs/post-phase2-browser-recapture-run`
...
Finish the active browser-recapture lane, open its docs-only PR, and then return the repo to human review of the submission package, IP commitment, optional video decision, and final sign-off.
