...
- Latest operating status: `ai_first/EXECUTION_QUEUE.md` is the shortest queue/status board, `ai_first/ACTIVE_ASSIGNMENTS.md` is the active coordination board, and the 2026-04-25 smoke/evidence refresh is merged; no AI-owned lane is active until screenshot refresh is picked up.
